...
public class eventcontroller {
    ...
    public event publish(@PathVariable String topic, @PathVariable String name){
        event pageEvent= new event(name,Math.random()>0.5?"U1":"U2",new Date(),new Random().nextInt(9000));
